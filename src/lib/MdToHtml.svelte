...
<div class="column section">
  <div class="card">
    ...
    <div class="card-content">
      <div class="content">
        <p class="help">
          Before converting your markdown, select all image files you're using for your article and drag them to the <a href="https://www.kodeco.com/wp-admin/upload.php"> WordPress Media Library</a>
          for bulk uploading.<br />
          The converter will find the images and replace any local image paths with the image URLs automatically.
        </p>
        <p class="help">
          Unsure how to format your markdown? Check out <a href="https://raw.githubusercontent.com/BlackDragonBE/kodeco-web-toolbox/master/public/markdown_sample.md">this sample markdown file</a>.
        </p>
